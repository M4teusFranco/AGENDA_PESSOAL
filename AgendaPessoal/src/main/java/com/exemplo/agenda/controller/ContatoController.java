...
/**
 * Classe responsável por controlar a inteção entre a View e o Model
 */
public class ContatoController {
		 ...
		 * 
		 * @paran view A interface gráfica que o usuário vê e interage.
		 * @paran model O modelo que lida com os dados.
		 */
